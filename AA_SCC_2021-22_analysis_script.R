#-----------------------------------------------------------------#
# A d u l t   a s t h m a   s c c   a n a l y s i s   s c r i p t #
#                                                                 #
# Author: Alex Adamson                                            #
#-----------------------------------------------------------------#
...
dat <- readRDS("Z:/Group_work/Alex/Encrypted/Alex/Adult Asthma/SCC 2021-2022/Data/tidyData/AA_SCC_2021-22_clean_data_2022-08-25.RDS")
...
flat.all <- flat.all %>% select(hosp_code:record_N, country:`PEF_b2a_steroids_oxygen_1hr_combo_All_<1_hour_perc`) %>% 
...
# Read in the names of the columns we have to remove

keep <- readRDS("Z:/Group_work/PS_AA/Adult Asthma Secondary Care Clinical 2021-2022/Data/tidyData/keep_vars.RDS")
remove <- readRDS("Z:/Group_work/PS_AA/Adult Asthma Secondary Care Clinical 2021-2022/Data/tidyData/remove_vars.RDS")

flat.all <- flat.all %>% select(-any_of(remove))

# write.csv(flat.all,
#  "Z:/Group_work/PS_AA/Adult Asthma Secondary Care Clinical 2021-2022/Data/dataStore/AA_SCC_2021-2022_hospital_level_data_2022-08-25.csv",
#           row.names = FALSE)
